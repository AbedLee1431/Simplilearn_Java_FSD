...
public class VirtualKeyForYourRepositories {
	 static String DIRECTORY;
	    ...
	    public VirtualKeyForYourRepositories() {
	    ...
	    void showPrimaryMenu() {
	        ...
	        try{
	            ...
	            switch (option){
	                ...
	                case 3 : {
	                    System.out.println("Thank You have a greate day");
	                    System.exit(0);
	                }
	    ...
	    void showSecondaryMenu() {
	        ...
	        try{
	            ...
	            switch (option){
	                case 'a' : {
	                    System.out.print("↳ Adding your file...Enter a File Name you want to set: ");
	                    String filename = scanner.next().trim().toLowerCase();
	                    addFile(filename);
	                    break;
	                }
	                case 'b' : {
	                    System.out.print("↳ Deleting your file...Enter the File Name you want to delete : ");
	                    String filename = scanner.next().trim();
	                    deleteFile(filename);
	                    break;
	                }
	                case 'c' : {
	                    System.out.print("↳ Searching your file...Enter a File Name : ");
	                    String filename = scanner.next().trim();
	                    searchFile(filename);
	                    break;
	                }
	    ...
	    public static void main(String[] args) {
	        ...
	        VirtualKeyForYourRepositories menu = new VirtualKeyForYourRepositories();
